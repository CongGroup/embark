#ifndef CLICK_POLLDEVICE_USERLEVEL_HH
#define CLICK_POLLDEVICE_USERLEVEL_HH
...
#define POLLDEVICE_LINUX 0 
#define POLLDEVICE_PCAP  0
...
class PollDevice : public Element { public:
  ...
  private:
    ...
    friend void PollDevice_get_packet(u_char*, const struct pcap_pkthdr*,
				      const u_char*);
