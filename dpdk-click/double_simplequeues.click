...
//Input Devices
pd0::PollDevice(p3p2, QUEUE 0, BURST 32) -> Strip(14) -> CheckIPHeader2() -> MarkIPHeader() -> EtherEncap(0x800, 66:55:44:33:22:11, 66:55:44:33:22:11) -> SimpleQueue(20000) -> dp0;

pd1::PollDevice(p4p2, QUEUE 0, BURST 32) -> Strip(14) -> CheckIPHeader2() -> MarkIPHeader() -> EtherEncap(0x800, 66:55:44:33:22:11, 66:55:44:33:22:11) -> SimpleQueue(20000) -> dp1;
