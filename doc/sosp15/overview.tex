...
\todo{say that service provider consists of frontend and a set of middleboxes }
...
\todo{this table is a bit confusing -- better say whether they are dpi or header, also maybe what is field it operates
