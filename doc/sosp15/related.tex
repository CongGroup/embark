...
\sys is the first system that enables running a wide range of middleboxes at a service provider while protecting the confidentiality of the traffic from the provider.  
There has been little work enabling both confidentiality/privacy and network processing. 
