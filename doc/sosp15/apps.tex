...
Unlike the previously presented middleboxes, all of which are devices which perform Intrusion Detection/Prevention (IDS/IPS) operate over the TCP bytestream, not just over packets and headers independently.
