...
The key idea is to encrypt packets {\it field-by-field} using a computational encryption scheme.
...
%%% DO NOT DELETE.
So far, we have decribed the overall architecture of \sys without discussing how the encryption or middleboxes themselves are implemented.
