...
This is conceptually the same as the technique we apply to convert regular expressions to exact-match strings.
However, just as we cannot use this technique for all regular expressions, the overhead of using this techniques for typical range queries like firewall rules is prohibitive.
