...
AES is a well known encryption technique and we do not discuss it here. Instead, we briefly discuss keyword match (introduced by~\cite{blindbox}, to which we refer the reader for details) and more extensively discuss RangeMatch, a new cryptographic scheme we designed for this setting.
