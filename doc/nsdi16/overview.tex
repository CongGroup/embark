...
Using these algorithms, a plaintext packet is encrypted, field-by-field, to generate a new IPv6 packet that is processed at the cloud.
...
We revisit these middleboxes in detail in \S\ref{sec:newmb}, but we summarize their requirements for our encryption scheme as follows:
