...
\sys's setting targets enterprise outsourcing where BlindBox targets independent users connecting to arbitrary middleboxes. This difference brings \sys new opportunities: it
