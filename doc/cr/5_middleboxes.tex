...
First, for intrusion detection, \sys does not support regular expressions that cannot be expanded in a certain number of keyword matches. \sys does not support running detection scripts on the traffic as in Bro~\cite{Bro}.
