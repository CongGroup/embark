...
Table~\ref{tbl:mbreqs} shows the functionality provided by \sys as a result of using PrefixMatch and KeywordMatch. In Appendix~\ref{sec:appendix:middleboxes} we explain why this functionality implies the core functionality of the middleboxes in Table~\ref{tbl:mbreqs}.
