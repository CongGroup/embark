...
\sys supports a wide range of middleboxes with practical performance.  Table~\ref{tbl:mbreqs} shows the relevant middleboxes, the desired functionality from encryption to support these, and the functionality \sys provides.
