...
\begin{flalign*}
& \text{Let $A$ be the action of a firewall rule, } \\
...
\text{Deterministic: } & (SIP_1, SP_1)\ =\ (SIP_2, SP_2) \ \Rightarrow \ (SIP_1', SP_1')\ =\ (SIP_2', SP_2')
\end{flalign*}
} 
& PrefixMatch \\ \hline
...
\parbox {8cm}{
\begin{flalign*}
\text{Deterministic: } & (SIP_1, DIP_1, SP_1, DP_1, P_1)\ =\ (SIP_2, DIP_2, SP_2, DP_2, P_2) \ \Rightarrow \\
