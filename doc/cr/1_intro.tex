...
\begin{tabular}{|c|>{\raggedright}m{2.5cm}|>{\raggedright}m{8.2cm}|l|l|}
\hline
...
\parbox {8cm}{
\begin{flalign*}
(SIP_1, SP_1) = (SIP_2, SP_2) &\Rightarrow \Enc(SIP_1, SP_1) = \Enc(SIP_2, SP_2) 
\end{flalign*}
}
& Yes & PrefixMatch \\  \cline{2-5} 
...
%
%
&  Data Exfiltration~\cite{exfiltration}/  Watermark Detection 
&
...
& \multirow{4}{*}{Intrusion detection~\cite{snort, bro}}
&
...
& &
Run intrusion detection scripts on traffic stream / Other advanced statistical techniques
 &
No & - \\ \hline
...
\todo{this table still does not make sense because of the NAT problem. }
\todo{Explain what is second column and put reference to appendix, I think we should say func desired}
