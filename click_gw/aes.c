...
void AES_cbc128_decrypt(const unsigned char *in, unsigned char *out,
                           size_t len, const void *key,
                           unsigned char ivec[16], my_block128_f block)
{
    size_t n;
                     ...
                     unsigned char *ivec, const int enc)
{
    ...
    if (enc)
        AES_cbc128_encrypt(in, out, len, key, ivec,
                              (my_block128_f) AES_encrypt);
    else
        AES_cbc128_decrypt(in, out, len, key, ivec,
                              (my_block128_f) AES_decrypt);
}
