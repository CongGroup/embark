...
extern_dev :: SniffGatewayDevice(eth12, 0);
extern_dev2 :: SniffGatewayDevice(eth12, 1);
intern_dev :: SniffGatewayDevice(eth8, 0);
intern_dev2 :: SniffGatewayDevice(eth8, 1);

StaticThreadSched(extern_dev/from 0, extern_dev/to 0, extern_dev2/from 1, extern_dev2/from 1, intern_dev/from 0, intern_dev/to 0, intern_dev2/from 1, intern_dev2/from 1 )
